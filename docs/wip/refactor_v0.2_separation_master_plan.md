...
| 3 | ショートカットレジストリの作成 | ✅ 完了 |
| 4 | サイドバー用ショートカットの移動 | ✅ 完了 |
| 5 | ファイルシステム監視のサイドバー部分移動 | ✅ 完了 |
| 6 | settings.js のサイドバー関連分離 | ✅ 完了 |
| 7 | state.js のサイドバー関連整理 | ✅ 完了 |
| 8 | シンプルモード機能の実装 | ⏳ 保留 (WIP計画案作成済み) |
| 9 | 統合テストとクリーンアップ | ✅ 完了 |
| 10 | 関連ドキュメントの更新 | ⬜ 未着手 |
...
### フェーズ 5: ファイルシステム監視のサイドバー部分移動【※実装完了】
...
### フェーズ 7: state.js のサイドバー関連整理【※実装完了】
...
### フェーズ 8: シンプルモード機能の実装（※一旦キャンセル、後々実装を検討することとする）
