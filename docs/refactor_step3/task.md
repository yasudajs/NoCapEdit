...
## フェーズ 3: 実装作業 <!-- id: 5 -->
- [x] `src/dist/i18n.js` に `fontSize.defaultOption` と `lineHeight.defaultOption` を追加 <!-- id: 6 -->
- [x] `src/dist/index.html` の 20pt / 1.5 の option に `data-i18n` 属性を付与 <!-- id: 7 -->

## フェーズ 4: 検証・報告 <!-- id: 8 -->
- [x] `npm run tauri dev` で起動し、設定画面でデフォルト表記が正しくローカライズ表示されることを確認 <!-- id: 9 -->
- [x] `docs/refactor_step3/walkthrough.md` の作成 <!-- id: 10 -->
