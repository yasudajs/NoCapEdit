...
## フェーズ 3: 実装作業 <!-- id: 5 -->
- [ ] `src/settings.rs` の `AppSettings::load()` に `font_size` (8〜72) および `line_height` (1.0〜3.0) の `clamp` 処理を追加 <!-- id: 6 -->
- [ ] `src/settings.rs` に範囲制限検証用の単体テストを追加 <!-- id: 7 -->

## フェーズ 4: 検証・報告 <!-- id: 8 -->
- [ ] `cargo test` による単体テスト通過確認 <!-- id: 9 -->
- [ ] `docs/refactor_step9/walkthrough.md` の作成 <!-- id: 10 -->
